export default {
  dashboard: {
    ...
    avgResponse: '平均响应',
    averageTime: '平均时间',
    headroomSavings: '智能压缩节省',
    headroomModelDistribution: '模型分布',
    headroomSavingsTrend: '节省趋势',
    headroomSavingsTokensColumn: '节省 Token',
    timeRange: '时间范围',
    granularity: '粒度',
    day: '按天',
    hour: '按小时',
  ...
  accountContributions: {
    ...
    testSuccess: '账号检测通过',
    testFailed: '账号检测失败',
    testModalTitle: '选择检测模型',
    selectTestModel: '检测模型',
    selectTestModelHint: '选择用于本次检测的模型，将替代账号默认的检测模型。',
