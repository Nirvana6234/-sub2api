export default {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用共飞 AI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">共飞 AI 是一个共享 AI 服务平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用共飞 AI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到共飞 AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    backupChannel: '备用支付通道',
    backupChannelBadge: '主通道异常时使用',
    backupChannelHint: '主通道支付失败时，可以从这里前往备用页面完成付款',
    backupChannelFailureHint: '刚才的支付没有成功生成，请改用备用通道继续付款，避免重复等待。',
    backupChannelCta: '立即使用备用通道',
  ...
  tickets: {
    title: '我的工单',
    description: '有问题可以在这里提交，管理员会在这里回复你。',
    adminTitle: '工单管理',
    adminDescription: '查看并回复所有用户提交的工单。',
    create: '新建工单',
    subject: '标题',
    subjectPlaceholder: '一句话概括你的问题',
    content: '问题描述',
    contentPlaceholder: '请尽量写清楚遇到的问题、操作步骤和报错信息',
    submit: '提交',
    submitting: '提交中…',
    cancel: '取消',
    reply: '回复',
    replyPlaceholder: '补充说明或追问…',
    adminReplyPlaceholder: '输入回复内容…',
    close: '关闭工单',
    reopen: '重新打开',
    closedHint: '该工单已关闭，如需继续咨询请新建工单。',
    adminClosedHint: '该工单已关闭。重新打开后即可继续回复。',
    selectHint: '从左侧选择一个工单查看对话。',
    empty: '暂无工单',
    loading: '加载中…',
    ...
    markUnread: '标记未读',
    deleteSelected: '删除所选',
    deleteConfirm: '确定删除选中的 {count} 个工单吗？工单消息也会一并删除，且无法恢复。',
