export default {
  dashboard: {
    ...
    headroomSavings: 'Smart compression savings',
    headroomModelDistribution: 'Model distribution',
    headroomSavingsTrend: 'Savings trend',
    headroomSavingsTokensColumn: 'Saved tokens',
  ...
  accountContributions: {
    ...
    testModalTitle: 'Choose test model',
    selectTestModel: 'Test model',
    selectTestModelHint: 'Pick the model to use for this test, overriding the account default.',
  ...
  sharedRooms: {
    ...
    available: 'Available',
    unavailable: 'Unavailable',
    viewAccounts: 'View contributed accounts',
