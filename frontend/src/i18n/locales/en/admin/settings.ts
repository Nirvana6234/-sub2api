export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        latencyFallbackTitle: 'Latency-aware fallback',
        latencyFallbackDescription: 'Separate accounts by recent time-to-first-token and switch only when the source group is slow and the fallback group is clearly faster. Insufficient samples do not trigger it.',
        latencyThresholdLabel: 'Slow threshold (ms)',
        speedupRatioLabel: 'Fallback maximum latency ratio',
