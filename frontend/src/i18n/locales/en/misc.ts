export default {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to Cofly AI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Cofly AI is a shared AI service platform that helps you manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Cofly AI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to Cofly AI.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    backupChannel: 'Backup payment channel',
    backupChannelBadge: 'Use when main channel fails',
    backupChannelHint: 'If the main channel fails, complete your payment here instead',
    backupChannelFailureHint: 'The payment code was not created successfully. Switch to the backup channel to continue without waiting.',
    backupChannelCta: 'Use backup channel',
  ...
  tickets: {
    title: 'My Tickets',
    description: 'Submit a question here and an administrator will reply.',
    adminTitle: 'Tickets',
    adminDescription: 'Review and reply to tickets submitted by users.',
    create: 'New ticket',
    subject: 'Subject',
    subjectPlaceholder: 'Summarize your question in one line',
    content: 'Description',
    contentPlaceholder: 'Describe the problem, the steps you took, and any error messages',
    submit: 'Submit',
    submitting: 'Submitting…',
    cancel: 'Cancel',
    reply: 'Reply',
    replyPlaceholder: 'Add details or ask a follow-up…',
    adminReplyPlaceholder: 'Type your reply…',
    close: 'Close ticket',
    reopen: 'Reopen',
    closedHint: 'This ticket is closed. Open a new one to continue.',
    adminClosedHint: 'This ticket is closed. Reopen it to continue replying.',
    selectHint: 'Select a ticket on the left to view the conversation.',
    ...
    deleteConfirm: 'Delete {count} selected tickets? Their messages will also be deleted and cannot be restored.',
    actionInProgress: 'Working…',
    searchPlaceholder: 'Search subject or user email',
    createdAt: 'Created',
    you: 'You',
    support: 'Support',
    customer: 'User',
