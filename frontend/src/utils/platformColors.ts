...
const BADGE: Record<Platform, string> = {
  ...
  typesafe: 'bg-lime-500/10 text-lime-700 border-lime-500/30 dark:text-lime-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  typesafe: 'bg-lime-500/10 text-lime-700 dark:bg-lime-500/10 dark:text-lime-300',
...
const BORDER: Record<Platform, string> = {
  ...
  typesafe: 'border-lime-500/20 dark:border-lime-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  typesafe: 'border-lime-500/35 dark:border-lime-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  typesafe: 'bg-gradient-to-r from-lime-400 to-lime-500',
...
const TEXT: Record<Platform, string> = {
  ...
  typesafe: 'text-lime-700 dark:text-lime-300',
...
const ICON: Record<Platform, string> = {
  ...
  typesafe: 'text-lime-500 dark:text-lime-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  typesafe: 'bg-lime-500 text-white hover:bg-lime-600 active:bg-lime-700 dark:bg-lime-500/80 dark:hover:bg-lime-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  typesafe: 'bg-lime-100 text-lime-800 dark:bg-lime-900/40 dark:text-lime-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  typesafe: 'from-lime-500 to-lime-600',
