...
const form = reactive({ email: '', password: '', username: '', notes: '', role: 'user' as 'user' | 'admin', balance: '', concurrency: 1, rpm_limit: 0, account_management_enabled: false, contribution_rooms_enabled: false, headroom_compression_enabled: false })
...
watch(() => props.show, (v) => { if(v) Object.assign(form, { email: '', password: '', username: '', notes: '', role: 'user', balance: '', concurrency: 1, rpm_limit: 0, account_management_enabled: false, contribution_rooms_enabled: false, headroom_compression_enabled: false }) })
