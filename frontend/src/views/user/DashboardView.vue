  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        <UserDashboardServiceEntry :stats="stats" />
...
import UserDashboardServiceEntry from '@/components/user/dashboard/UserDashboardServiceEntry.vue'; import UserDashboardStats from '@/components/user/dashboard/UserDashboardStats.vue'; import UserDashboardCharts from '@/components/user/dashboard/UserDashboardCharts.vue'
