  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <HeadroomSavingsCard v-if="user?.headroom_compression_enabled" :stats="stats" />
...
import HeadroomSavingsCard from '@/components/user/dashboard/HeadroomSavingsCard.vue'
