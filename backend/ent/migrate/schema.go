...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "fallback_pool_used", Type: field.TypeBool, Default: false},
		{Name: "fallback_source_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "fallback_source_group_name", Type: field.TypeString, Nullable: true},
		{Name: "fallback_target_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "fallback_target_group_name", Type: field.TypeString, Nullable: true},
