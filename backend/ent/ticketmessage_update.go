...
func (_u *TicketMessageUpdate) AddSenderUserID(v int64) *TicketMessageUpdate {
...
func (_u *TicketMessageUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedSenderUserID(); ok {
		_spec.AddField(ticketmessage.FieldSenderUserID, field.TypeInt64, value)
	}
...
// AddSenderUserID adds value to the "sender_user_id" field.
func (_u *TicketMessageUpdateOne) AddSenderUserID(v int64) *TicketMessageUpdateOne {
	_u.mutation.AddSenderUserID(v)
	return _u
}
