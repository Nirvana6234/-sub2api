...
func init() {
	...
	// accountDescRateMultiplierUndeclared is the schema descriptor for rate_multiplier_undeclared field.
	accountDescRateMultiplierUndeclared := accountFields[12].Descriptor()
	// account.DefaultRateMultiplierUndeclared holds the default value on creation for the rate_multiplier_undeclared field.
	account.DefaultRateMultiplierUndeclared = accountDescRateMultiplierUndeclared.Default.(bool)
	...
	groupDescIsFallbackPool := groupFields[43].Descriptor()
	...
	// usagelogDescFallbackPoolUsed is the schema descriptor for fallback_pool_used field.
	usagelogDescFallbackPoolUsed := usagelogFields[15].Descriptor()
	// usagelog.DefaultFallbackPoolUsed holds the default value on creation for the fallback_pool_used field.
	usagelog.DefaultFallbackPoolUsed = usagelogDescFallbackPoolUsed.Default.(bool)
