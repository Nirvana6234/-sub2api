...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		AccountShareRewardRate:                                 settings.AccountShareRewardRate,
		AccountOwnUsageFeeRate:                                 settings.AccountOwnUsageFeeRate,
		...
		PlaygroundDefaultChatGroupIDs:  settings.PlaygroundDefaultChatGroupIDs,
