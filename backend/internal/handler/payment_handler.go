...
// VerifyOrderPublic keeps the legacy URL available for older result pages while
// requiring an authenticated owner. The signed resume-token endpoint is the
// only anonymous recovery path.
