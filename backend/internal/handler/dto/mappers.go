...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		AutoGroupStrategy:          k.AutoGroupStrategy,
		AutoGroupIDs:               append([]int64(nil), k.AutoGroupIDs...),
		Status:                     k.Status,
		...
		AutoGroupCurrentGroup:      GroupFromServiceShallow(k.AutoGroupCurrentGroup),
		AutoGroupCurrentModel:      k.AutoGroupCurrentModel,
		AutoGroupCurrentSelectedAt: k.AutoGroupCurrentSelectedAt,
	}
