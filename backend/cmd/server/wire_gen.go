...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, accountRepository, usageLogRepository, billingCacheService, concurrencyService, settingService)
	...
	resultCacheStore := repository.NewResultCacheStore(redisClient)
	resultCache := service.NewResultCache(resultCacheStore)
	apiKeyHandler := handler.NewAPIKeyHandler(apiKeyService, resultCache)
	...
	usageHandler := handler.NewUsageHandler(usageService, apiKeyService, opsService, settingService, resultCache)
	...
	adminUsageHandler := admin.NewUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, resultCache)
	...
	pawConfigService := service.ProvidePawConfigService(apiKeyService, userService, channelService, userAttributeService, pricingService)
	pawChatService := service.ProvidePawChatService(pawConfigService, apiKeyService)
	...
	guestTrialService := service.NewGuestTrialService(settingService, guestTrialQuota, authService)
	guestTrialHandler := handler.NewGuestTrialHandler(guestTrialService)
	remotePairingRepository := repository.NewRemotePairingRepository(db)
