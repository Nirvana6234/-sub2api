...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, accountRepository, billingCacheService, concurrencyService, usageLogRepository, settingService)
	...
	adminLoginAttemptCache := repository.NewAdminLoginAttemptCache(redisClient)
	authService := service.ProvideAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, tencentCaptchaService, aliyunCaptchaService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, apiKeyService, adminLoginAttemptCache)
	...
	accountContributionHandler := handler.ProvideAccountContributionHandler(userService, adminService, accountUsageService, accountTestService, rateLimitService, apiKeyService, proxyExitInfoProber, client, oAuthService, openAIOAuthService)
