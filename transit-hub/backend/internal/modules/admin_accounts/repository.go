...
var workspaceDeleteStatements = []workspaceDeleteStatement{
	...
	{Name: "upstream_error_alert_cooldowns", SQL: `DELETE FROM upstream_error_alert_cooldowns WHERE user_id = $1 AND admin_account_id = $2`},
...
var legacyWorkspaceTables = []workspaceTableDescriptor{
	...
	{Name: "upstream_error_alert_cooldowns", WorkspaceColumn: "admin_account_id"},
