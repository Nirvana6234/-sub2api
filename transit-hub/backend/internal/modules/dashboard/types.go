...
const (
	...
	ErrorAuthRejected                = "admin.dashboard.adminAuth.errors.authRejected"
	ErrorInteractiveLoginRequired    = "admin.dashboard.adminAuth.errors.interactiveLoginRequired"
	ErrorUpstreamRequest             = "admin.dashboard.adminAuth.errors.upstreamRequest"
	ErrorInvalidResponse             = "admin.dashboard.adminAuth.errors.invalidResponse"
