...
export type StrategySettings = {
  ...
  enableResourceUsageAlert: boolean
  resourceUsageCpuThreshold: number
  resourceUsageMemoryThreshold: number
  resourceUsageNotifyBotIds: string[]
  resourceUsageTemplate: string
  resourceUsageTemplateFormat?: NotificationTemplateFormat
  enableUpstreamErrorAlert: boolean
  upstreamErrorNotifyBotIds: string[]
  /**
