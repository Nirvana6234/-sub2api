...
export const listUpstreamRecharges = async (id: string): Promise<UpstreamRechargeEntry[]> => (
  requestJson<UpstreamRechargeEntry[]>(`/upstream-sites/${id}/recharges`)
)

export const addUpstreamRecharge = async (id: string, amount: number, note: string): Promise<UpstreamSiteResponse> => (
  requestJson<UpstreamSiteResponse>(`/upstream-sites/${id}/recharges`, {
    method: 'POST',
