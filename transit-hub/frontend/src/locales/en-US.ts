export default {
  ...
  cta: {
    ...
    subtitle: 'Join thousands of developers using 共飞后台管理 to power their API infrastructure. Get started for free today.',
    deployBtn: 'Deploy Now',
    salesBtn: 'Contact Sales'
  },
  footer: {
    rights: 'Gongfei Operations. All rights reserved.'
  },
  auth: {
    ...
    register: {
      ...
      subtitle: 'Enter your details to register for 共飞后台管理',
      email: 'Email',
      emailPlaceholder: "name{'@'}example.com",
      password: 'Password',
  ...
  admin: {
    ...
    menu: {
      ...
      settings: 'Settings',
      tickets: 'Tickets',
      latencyCompensation: 'Latency Subsidy',
    ...
    adminAccounts: {
      ...
      delete: {
        ...
        title: 'Delete {name}',
        localDataWarning: 'All 共飞后台管理 local workspace data for this workspace will be permanently deleted. This cannot be undone.',
    ...
    dashboard: {
      ...
      attention: {
        ...
        unmonitoredTitle: 'Targets No Longer Probed',
        unmonitoredDescription: 'Only historical state remains for these targets; no enabled policy probes them anymore. Restore the model configuration or clean them up.',
      ...
      balanceFilter: {
        ...
        add: 'Add',
        usdToCnyRate: 'USD → CNY rate',
        usdToCnyRateHelp: 'Admin-site revenue and user balances are converted to CNY with this multiplier so they can be compared against upstream cost in the same currency. Leave blank or 0 to keep the current value.',
        cancel: 'Cancel',
        save: 'Save',
        saving: 'Saving...',
    ...
    connectionHealth: {
      ...
      manualMultiplierDialog: {
        title: 'Set Upstream API Key Multiplier',
        multiplier: 'Multiplier',
        invalid: 'Enter a valid number between 0 and 1000000.',
        clear: 'Clear manual value',
        cancel: 'Cancel',
        save: 'Save',
        saving: 'Saving...',
        close: 'Close'
      ...
      groupDetail: {
        multiplierPriority: 'Lowest Upstream Cost',
        autoPriority: 'Auto Score · {strategy}',
        priorityStrategies: {
          price: 'Lowest Cost',
          balanced: 'Balanced',
          speed: 'Fastest'
        ...
        columns: {
          ...
          autoSignals: 'Auto Score Signals',
        ...
        autoSignals: {
          usageP95: 'TTFT P95 {value} ms · {count} samples',
          usageFallback: 'Insufficient TTFT samples ({count}/3)',
          schedulerScore: 'Scheduler reference {value}',
          concurrency: 'Concurrency {current}/{limit}'
        },
        upstreamMultiplierPending: 'Shown after linking',
        upstreamMultiplierManual: 'Manual',
        upstreamMultiplierCached: 'Cached',
        editUpstreamMultiplier: 'Set upstream API key multiplier',
        models: {
      ...
      setup: {
        ...
        strategy: {
          ...
          options: {
            multiplier: {
              ...
              description: 'Reads each account\'s linked upstream API key multiplier. Lower multiplier receives higher priority.'
            },
            auto: {
              title: 'Auto Score',
              description: 'Scores by lowest cost, balance, or speed; paused, disabled, and unschedulable targets always go last.'
            },
            multiplierOnly: {
              title: 'Multiplier Only',
              description: 'Adjusts priority only from the real upstream API key multiplier. Never probes models or runs remote actions.'
            },
            stable: {
          ...
          priorityStrategyLabel: 'Scoring Mode',
          priorityStrategies: {
            price: 'Lowest Cost',
            balanced: 'Balanced',
            speed: 'Fastest'
        ...
        confirm: {
          ...
          enabled: 'Enabled',
          disabled: 'Disabled',
          multiplierRule: 'Priority rule: usable targets follow the selected scoring mode; paused, disabled, unschedulable, or zero-weight targets share the final slot. Sub2API sorts independently inside each group and stops overwriting after a manual priority edit.',
          multiplierOnlyRule: 'Multiplier-only does not launch model probes, but existing health state still moves unavailable targets last. All other targets sort by real upstream API key multiplier, lowest first. Disabling or detaching restores the pre-managed priority, with manual-edit conflict protection.'
        },
        back: 'Back',
        next: 'Next',
      ...
      remoteActions: {
        ...
        sub2apiSchedulableFalse: 'Sub2API account marked unschedulable',
        sub2apiSchedulableTrue: 'Sub2API account marked schedulable',
        sub2apiSchedulableFalseFailed: 'Failed to mark the Sub2API account unschedulable',
        sub2apiSchedulableTrueFailed: 'Failed to mark the Sub2API account schedulable',
      ...
      policyDrawer: {
        ...
        modelTargetsLabelLightweight: 'Health Tracking Label (optional)',
        autoScoreUnavailableLightweight: 'Lightweight liveness check provides no TTFT data; auto-scoring is unavailable',
        probeModeLabel: 'Probe Method',
        probeModes: {
          real_model: {
            title: 'Real Model Request',
            description: 'Calls the model endpoint, uses at most 1 token, provides TTFT data'
          },
          models_endpoint: {
            title: 'Lightweight Liveness Check',
            description: 'GET /v1/models to verify key validity — zero token cost'
          }
        },
        ...
        save: 'Save Policy',
        tooltips: {
          probeMode: 'Real model requests call the chat/completions endpoint using at least 1 token (provides TTFT data for auto-scoring). Lightweight liveness checks only request GET /v1/models to verify key and endpoint reachability — zero token cost, but cannot detect specific model availability or provide TTFT data.',
      ...
      modal: {
        ...
        form: {
          ...
          refreshTokenPlaceholder: 'Paste refresh_token; it is used when the Access Token expires or nears expiry',
          tokenType: 'Token Type',
          tokenTypePlaceholder: 'Defaults to Bearer',
          tokenHelp: 'The current access_token is validated first so an expired refresh_token cannot block a valid session. JWT expiry is detected automatically and refresh runs when needed.',
          userId: 'User ID',
      ...
      siteSettings: {
        ...
        saving: 'Saving...',
        cancel: 'Cancel',
        manualAccounting: 'Manual Balance Ledger',
        manualAccountingHelp: 'For sites whose upstream balance cannot be read. The first entry can be the historical balance; later syncs calculate Sub2API consumption from group usage and current group multipliers.',
        rechargeAmountPlaceholder: 'Recharge amount',
        rechargeNotePlaceholder: 'Note (optional)',
        addRecharge: 'Record Recharge',
        rechargeInvalid: 'Enter a recharge amount greater than 0.',
        rechargeLoadError: 'Could not load recharge history.',
        rechargeNoNote: 'No note',
        rechargeEmpty: 'No recharge balance recorded.',
        manualGroupMultipliers: 'Manual group multipliers',
        manualGroupMultipliersHelp: 'When account metadata or groups cannot be read, only API-key usage in these configured groups is charged. Unconfigured groups are never guessed as 1x.',
        addManualGroupMultiplier: 'Add group',
        removeManualGroupMultiplier: 'Remove group',
        manualGroupNamePlaceholder: 'Sub2API group name',
        manualMultiplierPlaceholder: 'Multiplier, e.g. 0.08'
      },
      viewMode: {
        list: 'List Mode',
        card: 'Card Mode'
      ...
      errors: {
        ...
        adminRequired: 'The token is valid, but the account is not a Sub2API admin. Management requires an admin token or Admin API Key.',
        interactiveLoginRequired: 'This site uses Turnstile. Sign in through its web page and paste the session token, or use an Admin API Key.',
    ...
    latencyCompensation: {
      title: 'Latency Subsidy',
      subtitle:
        'Refund requests that were slow to first token in a given window — bill at cost price and refund the margin. Each task is its own threshold/ratio config; run it manually or let it run automatically.',
      tasksTitle: 'Subsidy tasks',
      newTask: 'New task',
      editTask: 'Edit task',
      taskName: 'Task name',
      taskNamePlaceholder: 'e.g. Weeknight subsidy',
      taskSummary: 'Daily {windowStart}~{windowEnd} · Threshold {seconds}s · Refund ratio {ratio}%',
      autoBadge: 'Auto · daily {time}',
      manualBadge: 'Manual',
      run: 'Run',
      runTitle: 'Run task: {name}',
      runHint: 'Preview first — nothing is actually paid out until you confirm. Saving a task or opening this panel never runs it automatically.',
      tasksLoading: 'Loading tasks…',
      tasksEmpty: 'No tasks yet — click "New task" in the top right to create one.',
      tasksLoadFailed: 'Failed to load tasks',
      invalidName: 'Please enter a task name',
      save: 'Save',
      windowStart: 'Subsidy window · start',
      windowEnd: 'Subsidy window · end',
      windowHint: "Only requests within this daily window count toward the subsidy — not the whole calendar day. The end time also triggers the automatic run.",
      invalidWindow: 'The window end must be after the start',
      autoEnabled: 'Run automatically every day',
      autoEnabledHint: 'When on, this task runs automatically at {time} every day (the window end time above) — no need to click "Run" manually.',
      recurrenceType: 'Repeat',
      recurrenceDaily: 'Daily',
      recurrenceWeekly: 'Weekly',
      recurrenceWeekday: 'Weekdays',
      weekdayMon: 'Mon',
      weekdayTue: 'Tue',
      weekdayWed: 'Wed',
      weekdayThu: 'Thu',
      ...
      weekdaySatShort: 'Sa',
      weekdaySunShort: 'Su',
      invalidWeekdays: 'Pick at least one day of the week for a weekly schedule',
      autoBadgeWeekday: 'Auto · weekdays {time}',
      autoBadgeWeekly: 'Auto · weekly ({days}) {time}',
      validityEnabled: 'Limit to a date range',
      validityHint: "Off = always active, independent of the repeat pattern above — this only bounds which calendar dates this automatic schedule is active on.",
      validFrom: 'Valid from',
      validUntil: 'Valid until',
      invalidValidity: 'The end date cannot be before the start date',
      validityFromOnly: 'from {date}',
      validityUntilOnly: 'until {date}',
      confirmDelete: 'Delete this task?',
      from: 'From',
      to: 'To',
      thresholdSeconds: 'Slow-request threshold (seconds)',
      ...
      totalCompensation: 'Total subsidy',
      user: 'User',
      requests: 'Requests',
      compensation: 'Subsidy amount',
      noneQualified: 'No requests in this window are both eligible and not yet subsidized.',
      ...
      applyFailed: 'Failed to pay subsidy',
      applyConfirmTitle: 'Confirm subsidy payout',
      applyConfirmMessage:
        "This will credit a total of \${amount} to {count} users' balances directly on the Sub2API side. Continue?",
      applySuccess: 'Paid a total of ${amount} to {count} users',
      confirm: 'Confirm',
      cancel: 'Cancel',
      historyTitle: 'Payout history',
      historyLoading: 'Loading history…',
      historyEmpty: 'No subsidy has been paid out yet.',
      historyUsersCount: '{count} users',
      revoke: 'Revoke',
      confirmRevoke: 'Revoke this entire batch?',
      revokedBadge: 'Revoked',
      revokeSuccess: 'Revoked — {count} users\' balances reversed',
      revokePartialSuccess: 'Partially revoked: {revoked} users reversed, {skipped} skipped (insufficient balance)',
    ...
    settings: {
      ...
      sections: {
        ...
        thresholds: {
          ...
          upstreamErrorWarning: 'Request 502/503 Error Alert',
          upstreamErrorWarningHelp: 'Polls recent Sub2API request errors and sends a Feishu alert grouped by upstream group when 502 or 503 errors appear.',
          upstreamErrorCooldown: 'The same workspace and group are notified at most once every 3 hours.'
        },
        dailyReport: {
